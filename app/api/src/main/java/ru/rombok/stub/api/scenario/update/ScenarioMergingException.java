...
public class ScenarioMergingException extends RuntimeException {
    ...
    public static ScenarioMergingException forGetterInvocation(UUID scenarioUuid, Exception e) {
        return new ScenarioMergingException(scenarioUuid, "Failed to invoke getter", e);
    }

    public static ScenarioMergingException forGetterInvocation(UUID scenarioUuid) {
        return forGetterInvocation(scenarioUuid, null);
    }
}
